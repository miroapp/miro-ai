...
---
# Using Miro with Codex

## What is Miro MCP?

Miro MCP (Model Context Protocol) enables Codex to interact directly with Miro boards. Create diagrams, documents, and tables; read board content; and extract structured documentation from visual designs.
