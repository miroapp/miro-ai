...
| Workflow patterns | Manual tool choice | Auto-activating skills (e.g. `$miro:miro-browse`) |

## Available Plugins

| Plugin | Description | Surface |
|--------|-------------|---------|
| `miro` | Core MCP integration | Skills `miro-browse`, `miro-code-review`, `miro-code-spec`, `miro-code-explain-on-board` plus the Miro MCP tools |
